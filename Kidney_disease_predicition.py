...
tk.Label(root,text='White blood cell count (4000-11000)microleter', font=("times new roman", 12)).grid(row=3,column=0)
cp = tk.IntVar()
tk.Entry(root,textvariable=cp).grid(row=3,column=1)

tk.Label(root,text='blood Urea (5-20)mg/dl', font=("times new roman", 12)).grid(row=4,column=0)
tbps = tk.IntVar()
tk.Entry(root,textvariable=tbps).grid(row=4,column=1)

tk.Label(root,text='blood glucose random (less than 140) mg/dL', font=("times new roman", 12)).grid(row=5,column=0)
chol = tk.IntVar()
tk.Entry(root,textvariable=chol).grid(row=5,column=1)

tk.Label(root,text="""fbs:serum creatinine (0.74-1.35) mg/dL	""",padx=20, font=("times new roman", 12)).grid(row=6,column=0)
fbs=tk.IntVar()
...
tk.Label(root,text='albumin (3.4-5.4)g/dL', font=("times new roman", 12)).grid(row=8,column=0)
thalach = tk.IntVar()
